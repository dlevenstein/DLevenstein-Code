...
%rr = 1;
    ...
    for gg = 1:numinregiongroups
      %  gg = 1;
        ...
        if sum(ismember(specialchannels,groupchannels))>0 %CHANNEL PICKED
            ...
            groupchannels = groupchannels(minnoisechannel);
        end
